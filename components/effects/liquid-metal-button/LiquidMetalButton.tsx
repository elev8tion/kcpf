/* Ported from the verified Traevu source:
   src/shaders/liquid-metal-button/LiquidMetalButton.tsx
   Source revision: SHA-256 76624e881a3a.
   Host-boundary adaptations only:
   1. raw ?raw import -> generated byte-for-byte string module (Next.js has no ?raw).
   2. "use client" directive (Next.js App Router requirement).
   Renderer, bridge, iframe sandbox, and interaction behavior are source-exact. */
"use client";

import { useCallback, useEffect, useMemo, useRef, useState } from "react";

import { liquidMetalButtonSource } from "./liquidMetalButtonSource";
