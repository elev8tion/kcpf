...
export type TraevuLaserVariant =
  | "atmospheric-blade"
  | "vanishing-array"
  | "prism-aperture"
  | "halftone-relay";
...
export const LASER_VARIANT_DEFAULTS = {
  variant: "atmospheric-blade" as TraevuLaserVariant,
  speed: 1,
  size: 1,
  length: 1,
  density: 1,
...
const VARIANT_INDEX: Record<TraevuLaserVariant, number> = {
  "atmospheric-blade": 0,
  "vanishing-array": 1,
  "prism-aperture": 2,
  "halftone-relay": 3,
...
export function LaserVariants({ className = "", style, ...props }: LaserVariantsProps) {
  ...
  return (
    <div
      ref={hostRef}
      className={`traevu-background laser-variant${className ? ` ${className}` : ""}`}
